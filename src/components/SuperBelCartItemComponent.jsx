...
import {superBelAllProducts} from '../helpers/superBelProducts';
import DeleteIcon from '../assets/delete_icon.png';

const SuperBelCartItemComponent = ({item}) => {
  ...
  const productImage = superBelAllProducts.find(
    p => p.name === item.name,
  )?.image;
...
export default SuperBelCartItemComponent;
